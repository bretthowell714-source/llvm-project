...
from ._exceptions import APIStatusError, SolargystixError
...
class Solargystix(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Solargystix client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("SOLARGYSTIX_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> SolargystixWithRawResponse:
        return SolargystixWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> SolargystixWithStreamedResponse:
        return SolargystixWithStreamedResponse(self)
...
class AsyncSolargystix(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSolargystix client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncSolargystixWithRawResponse:
        return AsyncSolargystixWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncSolargystixWithStreamedResponse:
        return AsyncSolargystixWithStreamedResponse(self)
...
class SolargystixWithRawResponse:
    _client: Solargystix

    def __init__(self, client: Solargystix) -> None:
        self._client = client
...
class AsyncSolargystixWithRawResponse:
    _client: AsyncSolargystix

    def __init__(self, client: AsyncSolargystix) -> None:
        self._client = client
...
class SolargystixWithStreamedResponse:
    _client: Solargystix
...
class AsyncSolargystixWithStreamedResponse:
    _client: AsyncSolargystix
